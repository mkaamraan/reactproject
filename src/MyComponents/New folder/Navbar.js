    ...
    return (
        ...
        <>
            <IconContext.Provider value={{ color: 'white' }} >
                ...
                <nav className={sidebar ? 'nav-menu active' : 'nav-menu'} style={{ backgroundColor: '#F8F0E3' }}>

                    <div style={{ position: 'absolute', left: 0, height: '100%', width: '10%', backgroundColor: 'blue' }}>
